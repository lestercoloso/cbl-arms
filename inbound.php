...
<div id="add_shipment" class="modal fade" role="dialog">
	...
	<div class="col-sm-4 row" id="">
		...
		<div class="form-group col-sm-12 addshipment_rack" id="customer_name_container">
	...
	<div class="col-sm-4 row" id="">
			...
			<div class="col-sm-8">
			<select class="form-control" id="addshipment_storage">
			<option value="rack">Rack</option>
			<option value="bay">Bay</option>
			</select>
			</div>
			...
			<div class="form-group col-sm-12 addshipment_rack" id="rack_code_container">
			<label class="col-sm-4  chosen-select" for="textinput" >Rack Code: </label>
			<div class="col-sm-8">
				<select class="form-control" id="rack_code" data-placeholder="Input rack code">
				</select>
			</div>
			</div>
			
			<div class="form-group col-sm-12 addshipment_rack" id="rack_level_container">
			...
			<div class="col-sm-8">
				<select class="form-control" id="bay_code" data-placeholder="Input bay code">
				</select>
			</div>
			</div>
